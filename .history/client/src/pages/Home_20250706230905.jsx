...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen gap-12 px-4 text-center bg-gradient-to-b">
      {/* Animated Logo */}
      <img
        src={Logo}
      ...
      <div className="backdrop-blur-md  border border-white/60 rounded-2xl shadow-xl px-8 py-6 flex gap-6 max-md:flex-col">
